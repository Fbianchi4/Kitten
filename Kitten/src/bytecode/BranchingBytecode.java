...
public abstract class BranchingBytecode extends Bytecode implements NonCallingBytecode {
	...
	public final InstructionList generateJavaBytecode(AbstractClassGenerator classGen, InstructionHandle yes, InstructionHandle no) {
	...
	protected abstract void generateJavaBytecodeAux(InstructionList il, AbstractClassGenerator classGen, InstructionHandle yes);
}