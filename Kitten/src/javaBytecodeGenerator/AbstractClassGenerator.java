...
/**
 * Classe astratta per i generatori di bytecode.
 * 
 * @author Federico Bianchi
 */

@SuppressWarnings("serial")
public abstract class AbstractClassGenerator extends ClassGen {
	...
	protected AbstractClassGenerator(
	        ...
	        short javaAttributes,
	        String[] interfaces,
	        ConstantPoolGen cpg) {
	    
	    super(className, superClassName, sourceFileName, javaAttributes,
	            interfaces, cpg);
	    
	    factory = new InstructionFactory(getConstantPool());
	}
